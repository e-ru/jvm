...
public class CustomJdbcTokenStore extends JdbcTokenStore {
	...
	public void storeRefreshToken(OAuth2RefreshToken refreshToken, OAuth2Authentication authentication) {
		jdbcTemplate.update(REFRESH_TOKEN_INSERT_STATEMENT, new Object[] { extractTokenKey(refreshToken.getValue()),
				authentication.getOAuth2Request().getClientId(), ((User) authentication.getPrincipal()).getUsername(),
